...
public class DeviceFactory {
	...
	public DispositivoEstandar crearDispEstandar(String t,String d) {
		...
		if(pos==-1) {
			System.out.println("No se encontr� el dispositivo buscado.");
		}
	...
	public static void main(String[] args) {
		...
		System.out.println("\n" + aire.getNombreDisp() + " " + aire.getEquipoConcreto() + ". 縀s de bajo consumo?: " + aire.getEsBajoConsumo());
		System.out.println(plancha.getNombreDisp() + " " + plancha.getEquipoConcreto() + ". 縀s de bajo consumo?: " + plancha.getEsBajoConsumo());
