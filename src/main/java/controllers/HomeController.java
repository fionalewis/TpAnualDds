...
public class HomeController implements WithGlobalEntityManager, TransactionalOps{
	...
	public ModelAndView map (Request req, Response res){
		Map<String, Object> model = new HashMap<>();
		String s = "1;0.0;(-34.617015,-58.446179);2;13486.22579166666;(-34.602957,-58.419014);3;0.0;(-34.575435,-58.423005);4;0.0;(-34.619663,-58.433519);5;6433.485149666667;(-34.610269,-58.398715);";
